...
Version  : 8.2504.0
Release  : 49
URL      : https://github.com/rsyslog/rsyslog/archive/v8.2504.0/rsyslog-8.2504.0.tar.gz
Source0  : https://github.com/rsyslog/rsyslog/archive/v8.2504.0/rsyslog-8.2504.0.tar.gz
...
%prep
%setup -q -n rsyslog-8.2504.0
cd %{_builddir}/rsyslog-8.2504.0
pushd ..
cp -a rsyslog-8.2504.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748373770
