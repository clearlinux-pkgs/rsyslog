...
Version  : 8.2408.0
Release  : 45
URL      : https://github.com/rsyslog/rsyslog/archive/v8.2408.0/rsyslog-8.2408.0.tar.gz
Source0  : https://github.com/rsyslog/rsyslog/archive/v8.2408.0/rsyslog-8.2408.0.tar.gz
...
%prep
%setup -q -n rsyslog-8.2408.0
cd %{_builddir}/rsyslog-8.2408.0
pushd ..
cp -a rsyslog-8.2408.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724338536
