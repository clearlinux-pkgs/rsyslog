...
Source0  : https://github.com/rsyslog/rsyslog/archive/v8.2212.0/rsyslog-8.2212.0.tar.gz
...
%prep
%setup -q -n rsyslog-8.2212.0
cd %{_builddir}/rsyslog-8.2212.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670504865
