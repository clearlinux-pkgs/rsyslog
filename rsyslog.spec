...
%prep
%setup -q -n rsyslog-8.2202.0
cd %{_builddir}/rsyslog-8.2202.0
...
cp %{_builddir}/rsyslog-8.2202.0/COPYING.ASL20 %{buildroot}/usr/share/package-licenses/rsyslog/a0e4cbb52a11ad6dd1e4d27c0bd948eb2abc0188
cp %{_builddir}/rsyslog-8.2202.0/COPYING.LESSER %{buildroot}/usr/share/package-licenses/rsyslog/1e2bf763a406378034f0722de926e819c31ed211
cp %{_builddir}/rsyslog-8.2202.0/contrib/imhiredis/COPYING %{buildroot}/usr/share/package-licenses/rsyslog/d2773a247962f107e65362fbb37d20cdf979d0ff
cp %{_builddir}/rsyslog-8.2202.0/contrib/imhiredis/COPYING_LESSER %{buildroot}/usr/share/package-licenses/rsyslog/75b8e4445cd2df277d34b4ee6f5b1c06fca7cc91
cp %{_builddir}/rsyslog-8.2202.0/contrib/omhiredis/COPYING %{buildroot}/usr/share/package-licenses/rsyslog/d2773a247962f107e65362fbb37d20cdf979d0ff
cp %{_builddir}/rsyslog-8.2202.0/contrib/omhiredis/COPYING_LESSER %{buildroot}/usr/share/package-licenses/rsyslog/75b8e4445cd2df277d34b4ee6f5b1c06fca7cc91
cp %{_builddir}/rsyslog-8.2202.0/solaris/cddllicense.txt %{buildroot}/usr/share/package-licenses/rsyslog/95df6148dd543173d4a3aedb646fc703e5bed82c
%make_install
