...
Source0  : https://github.com/rsyslog/rsyslog/archive/v8.2210.0/rsyslog-8.2210.0.tar.gz
...
%prep
%setup -q -n rsyslog-8.2210.0
cd %{_builddir}/rsyslog-8.2210.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666228583
