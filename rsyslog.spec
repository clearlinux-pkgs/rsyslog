...
Version  : 8.2310.0
Release  : 40
URL      : https://github.com/rsyslog/rsyslog/archive/v8.2310.0/rsyslog-8.2310.0.tar.gz
Source0  : https://github.com/rsyslog/rsyslog/archive/v8.2310.0/rsyslog-8.2310.0.tar.gz
...
%prep
%setup -q -n rsyslog-8.2310.0
cd %{_builddir}/rsyslog-8.2310.0
pushd ..
cp -a rsyslog-8.2310.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696953802
...
cp %{_builddir}/rsyslog-%{version}/COPYING.ASL20 %{buildroot}/usr/share/package-licenses/rsyslog/a0e4cbb52a11ad6dd1e4d27c0bd948eb2abc0188 || :
cp %{_builddir}/rsyslog-%{version}/COPYING.LESSER %{buildroot}/usr/share/package-licenses/rsyslog/1e2bf763a406378034f0722de926e819c31ed211 || :
cp %{_builddir}/rsyslog-%{version}/contrib/imhiredis/COPYING %{buildroot}/usr/share/package-licenses/rsyslog/d2773a247962f107e65362fbb37d20cdf979d0ff || :
cp %{_builddir}/rsyslog-%{version}/contrib/imhiredis/COPYING_LESSER %{buildroot}/usr/share/package-licenses/rsyslog/75b8e4445cd2df277d34b4ee6f5b1c06fca7cc91 || :
